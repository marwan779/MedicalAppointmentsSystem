...
namespace MedicalAppointmentsSystem.Migrations
{
    ...
    [Migration("20250716140755_UpdateUserComlaintsTableAddingDoctorReponse")]
    partial class UpdateUserComlaintsTableAddingDoctorReponse
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedicalAppointmentsSystem.Areas.Doctor.Models.UserAppointmentResponse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserAppointmentResponses");
                });
            ...
            modelBuilder.Entity("MedicalAppointmentsSystem.Models.DoctorAvailability", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedicalAppointmentsSystem.Models.DoctorInformation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedicalAppointmentsSystem.Models.UserComplaint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DoctorReponse")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("DoctorResponded")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("MedicalAppointmentsSystem.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("MedicalAppointmentsSystem.Models.Clinic", b =>
                {
                    b.HasOne("MedicalAppointmentsSystem.Models.ApplicationUser", "Doctor")
                        .WithMany()
            ...
            modelBuilder.Entity("MedicalAppointmentsSystem.Models.DoctorAvailability", b =>
                {
                    b.HasOne("MedicalAppointmentsSystem.Models.Clinic", "Clinic")
                        .WithMany()
